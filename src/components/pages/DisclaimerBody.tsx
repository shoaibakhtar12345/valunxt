 ...
 *
 * Port of disclaimer/index.php. The captured Elementor markup is unchanged: the only
...
export default function DisclaimerBody({ page, region }: { page: PageConfig; region: string }) {
  return (
    <>
      ...
      <div id="main-content">
      		...
      		<article id="post-9200" className="full post-9200 page type-page status-publish hentry">
      				<div data-elementor-type="single-page" data-elementor-id="3752" className="elementor elementor-3752 elementor-location-single post-9200 page type-page status-publish hentry" data-elementor-post-type="elementor_library">
      		...
      		<div className="elementor-element elementor-element-7b36cfb e-con-full e-flex e-con e-child" data-id="7b36cfb" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<span className="elementor-heading-title elementor-size-default">&gt; Disclaimer</span>				</div>
      				</div>
      				</div>
      		...
      		<div className="elementor-element elementor-element-8c0b074 e-con-full e-flex e-con e-child" data-id="8c0b074" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h1 className="elementor-heading-title elementor-size-default">Investment Disclaimer</h1>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h2 className="elementor-heading-title elementor-size-default">Disclaimer</h2>				</div>
      				</div>
      				</div>
      				</div>
      					</div>
      		...
      		<div className="elementor-element elementor-element-afe1311 e-con-full e-flex e-con e-parent" data-id="afe1311" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-element elementor-element-30c6cd5 e-flex e-con-boxed e-con e-parent" data-id="30c6cd5" data-element_type="container" data-e-type="container">
      					<div className="e-con-inner">
      		<div className="elementor-element elementor-element-44f0fa2 e-con-full e-flex e-con e-child" data-id="44f0fa2" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Important information about our content</h3>				</div>
      				</div>
      				...
      				<div className="elementor-element elementor-element-da2627d elementor-widget elementor-widget-heading" data-id="da2627d" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Not investment advice</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8d72be2 elementor-widget elementor-widget-text-editor" data-id="8d72be2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      									<p>Nothing on this website constitutes investment, financial, legal, accounting or tax advice, nor a recommendation, offer or solicitation to buy, sell or hold any security, property or investment product. Any decisions you make based on information found here are made at your own discretion and risk.</p>								</div>
      				</div>
      				<div className="elementor-element elementor-element-da2627d elementor-widget elementor-widget-heading" data-id="da2627d" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">No guarantee of results</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8d72be2 elementor-widget elementor-widget-text-editor" data-id="8d72be2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      				...
      				<div className="elementor-element elementor-element-da2627d elementor-widget elementor-widget-heading" data-id="da2627d" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Seek professional advice</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8d72be2 elementor-widget elementor-widget-text-editor" data-id="8d72be2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      									<p>Before acting on any information, you should obtain independent advice from qualified professionals who can assess your specific circumstances, objectives and risk tolerance.</p>								</div>
      				</div>
      				<div className="elementor-element elementor-element-da2627d elementor-widget elementor-widget-heading" data-id="da2627d" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Accuracy of information</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8d72be2 elementor-widget elementor-widget-text-editor" data-id="8d72be2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      				...
      				<div className="elementor-element elementor-element-da2627d elementor-widget elementor-widget-heading" data-id="da2627d" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Forward-looking statements</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8d72be2 elementor-widget elementor-widget-text-editor" data-id="8d72be2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      									<p>Certain content may contain forward-looking views about markets, sectors or strategies. These reflect opinion at a point in time, are subject to change, and involve known and unknown risks and uncertainties.</p>								</div>
      				</div>
      				<div className="elementor-element elementor-element-da2627d elementor-widget elementor-widget-heading" data-id="da2627d" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Group companies</h3>				</div>
      				</div>
      				<div className="vamtam-has-theme-widget-styles elementor-element elementor-element-8d72be2 elementor-widget elementor-widget-text-editor" data-id="8d72be2" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
      				<div className="elementor-widget-container">
      		...
      		<div className="elementor-element elementor-element-4b7d49d e-con-full e-flex e-con e-child" data-id="4b7d49d" data-element_type="container" data-e-type="container">
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Stay Ahead.</h3>				</div>
      				</div>
      				...
      				<div className="elementor-widget-container">
      					<h3 className="elementor-heading-title elementor-size-default">Subscribe for Market Intelligence.</h3>				</div>
      				</div>
      				</div>
      		<div className="elementor-element elementor-element-c96c2e7 elementor-invisible e-con-full animated-fast e-flex e-con e-child" data-id="c96c2e7" data-element_type="container" data-e-type="container" data-settings={"{\"animation\":\"fadeIn\",\"animation_delay\":150}"}>
      			...
      			<div className="elementor-form-fields-wrapper elementor-labels-">
      				...
      				<div className="elementor-widget-container">
      									<p>You can unsubscribe at any time using the link in the footer of our emails. View our <a href={rurl(region, '/privacy-policy/')}>Privacy Policy</a>.</p>								</div>
      				</div>
      				</div>
